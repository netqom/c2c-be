                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                                                        ...
                                                                                        <img alt="" src="{{$email_data['url']}}" style="width:auto;max-width: 100%;
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="bodyBackground">
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="">
                                                                        <tr>
                                                                            <td valign="top" class="bodyContainer" style="padding-top:10px; padding-bottom:10px;border-top: 5px solid red; ">
                                                                                ...
                                                                                <table class="mcnTextBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                    <tbody class="mcnTextBlockOuter">
                                                                                        <tr>
                                                                                            <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                                                                                                <table class="mcnButtonBlock" style="min-width:100%;margin-top: 20px;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                    <tbody class="mcnButtonBlockOuter">
                                                                                                        <tr>
                                                                                                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;text-align: left;" valign="top">
																											{!! $email_data['msg'] !!}.
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 10px 25px;" valign="middle" align="center">
                                                                                                                <a class="mcnButton " title="Create Connect Account" href="{{$email_data['url']}}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Create Account</a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" class="backgroundColor">
                                                                    <img src="https://gallery.mailchimp.com/27aac8a65e64c994c4416d6b8/images/eb_stubend.png" height="10" width="600" class="mcnImage" style="display:block; max-width:600px;">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
