...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{{ asset('public/admin_assets/media/logos/favicon.ico') }}" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{ asset('public/admin_assets/media/bg/bg-2.jpg') }});">
					...
					<!--end:login Header-->
						...
						<div class="login-signin">
							...
							<form class="form text-left" id="login-form" method="POST" action="{{ route('login') }}">
							@csrf
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 border-0 py-4 px-8 validate_email" type="email" placeholder="Email" name="email" autocomplete="off" required/>
								</div>
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 border-0 py-4 px-8" type="Password" placeholder="Password" name="password" required/>
								</div>
								...
								<div class="text-center mt-15">
									<button id="login_submit" class="btn btn-primary btn-pill shadow-sm py-4 px-9 font-weight-bold">Sign In</button>
								</div>
							</form>
						</div>
					</div>
