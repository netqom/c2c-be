            ...
            <div class="card card-custom">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">  List of Faq
                    </div>
					<div class="card-toolbar">
						<!--begin::Button-->
						<a href="javascript:;" onclick="addFaq()"  class="btn btn-light-primary btn-sm font-weight-bolder"><i class="la la-plus"></i>Add Faq</a>
						<!--end::Button-->
					</div>
                </div>
                <!--end::Header-->
                ...
                <div class="card-body">
					...
					<!--end::Search Form-->
                    <!--begin: Datatable-->
                    <div class="datatable datatable-bordered datatable-head-custom" id="kt_faq_datatable">
                    </div>
                    <!--end: Datatable-->
                </div>
                <!--end::Body-->
...
@push('scripts')
<script>
 function addFaq(id=0)
 {
	infoLoadingBox();
	$.ajax({
		url: BASE_URL +'/admin/faqs/get-add-edit-form/'+id,
		type: 'GET',
...
<script type="text/javascript">
     var data_url = "{{ admin_url('pages/get-faq-list') }}";
     var url_page_base = "{{ admin_url('pages') }}";	 
	 var token = '{{ csrf_token() }}';
	 var url_activate_deactivate = "{{ admin_url('pages/change-status') }}";
</script>
<script src="{{ asset('public/admin_assets/js/faq_datatable.js') }}"></script>
@endpush