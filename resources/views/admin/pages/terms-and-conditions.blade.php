											...
											@php $content = []; if($data->pageContents()->count()>0){ foreach($data->pageContents()->get() as $cont){ $content[$cont['param']] = $cont['value'];   } }
												...
												<div class="row">
													<div class="form-group col-md-12">
														<label class="form-control-label">Banner Image</label>
											             <input type="file" id="banner-image" name="terms_banner_image" class="form-control" @if(!isset($content['banner_image'])) required  @endif> 
												...
												<div class="row">
														<div class="form-group col-md-12">
															...
															<textarea id="terms_and_conditions" class="summernote" name="terms_and_conditions" required>{{ array_key_exists('terms_and_conditions',$content
                                                            ) ? $content['terms_and_conditions'] : old('terms_and_conditions') }}</textarea>
														</div>
												</div>
