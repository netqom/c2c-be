											...
											@php $content = []; if($data->pageContents()->count()>0){ foreach($data->pageContents()->get() as $cont){ $content[$cont['param']] = $cont['value'];   } }
												...
												<div class="row">
													<div class="form-group col-md-12">
														<label class="form-control-label">Banner Image</label>
											             <input type="file" id="banner-image" name="privacy_banner_image" class="form-control" @if(!isset($content['banner_image'])) required  @endif> 
												...
												<div class="row">
														<div class="form-group col-md-12">
															...
															<textarea id="privacy_policy" class="summernote" name="privacy_policy" required>{{ array_key_exists('privacy_policy',$content
                                                            ) ? $content['privacy_policy'] : old('privacy_policy') }}</textarea>
														</div>
												</div>
